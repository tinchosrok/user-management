...
namespace quoma\modules\UserManagement\models\search;
...
/**
 * UserVisitLogSearch represents the model behind the search form about `quoma\modules\UserManagement\models\UserVisitLog`.
 */
