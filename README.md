...
'components'=>[
	'user' => [
		'class' => 'quoma\modules\UserManagement\components\UserConfig',

		// Comment this if you don't want to record user logins
		'on afterLogin' => function($event) {
				\quoma\modules\UserManagement\models\UserVisitLog::newVisitor($event->identity->id);
			}
	],
],
...
'modules'=>[
	'user-management' => [
		'class' => 'quoma\modules\UserManagement\UserManagementModule',
...
'modules'=>[
	'user-management' => [
		'class' => 'quoma\modules\UserManagement\UserManagementModule',
	        'controllerNamespace'=>'vendor\quoma\modules\UserManagement\controllers', // To prevent yii help from crashing
	],
],
...
public function behaviors()
{
	return [
		'ghost-access'=> [
			'class' => 'quoma\modules\UserManagement\components\GhostAccessControl',
		],
	];
}
...
<?php
use quoma\modules\UserManagement\components\GhostMenu;
